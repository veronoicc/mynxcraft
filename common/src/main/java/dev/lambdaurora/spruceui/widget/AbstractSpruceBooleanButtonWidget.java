...
public abstract class AbstractSpruceBooleanButtonWidget extends AbstractSprucePressableButtonWidget {
	...
	public AbstractSpruceBooleanButtonWidget(Position position, int width, int height, Component message, boolean value) {
	...
	public AbstractSpruceBooleanButtonWidget(Position position, int width, int height, Component message,
