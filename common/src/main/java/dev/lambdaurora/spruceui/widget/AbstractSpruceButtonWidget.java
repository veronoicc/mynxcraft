...
public abstract class AbstractSpruceButtonWidget extends AbstractSpruceWidget implements Tooltipable {
	...
	/**
	 * @see net.minecraft.client.gui.components.AbstractButton#TEXTURES
	 */
	protected static final WidgetSprites
			BUTTON_TEXTURES = new WidgetSprites(
	...
	protected void renderButton(GuiGraphics graphics, int mouseX, int mouseY, float delta) {
		...
		graphics.drawCenteredString(this.client.font, this.getMessage(),
	...
	protected void renderBackground(GuiGraphics graphics, int mouseX, int mouseY, float delta) {
		...
		graphics.blitSprite(this.getTexture(), this.getX(), this.getY(), this.getWidth(), this.getHeight());
	}
