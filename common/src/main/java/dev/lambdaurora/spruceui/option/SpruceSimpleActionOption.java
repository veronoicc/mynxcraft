...
public final class SpruceSimpleActionOption extends SpruceOption {
	...
	public SpruceSimpleActionOption(String key, ButtonFactory buttonFactory, SpruceButtonWidget.PressAction action, @Nullable Component tooltip) {
		super(key);
	...
	public static SpruceSimpleActionOption of(String key, SpruceButtonWidget.PressAction action, @Nullable Component tooltip) {
		return new SpruceSimpleActionOption(key,
				(position, width, message, action1) -> new SpruceButtonWidget(position, width, 20, message, action1),
				action, tooltip);
	}
	...
	public static SpruceSimpleActionOption reset(SpruceButtonWidget.PressAction action, @Nullable Component tooltip) {
	...
	public static SpruceSimpleActionOption textured(String key, SpruceButtonWidget.PressAction action,
	                                                int u, int v, int hoveredVOffset, ResourceLocation texture) {
		return textured(key, action, u, v, hoveredVOffset, texture, null);
	}

	public static SpruceSimpleActionOption textured(String key, SpruceButtonWidget.PressAction action,
	                                                int u, int v, int hoveredVOffset, ResourceLocation texture, @Nullable Component tooltip) {
		return new SpruceSimpleActionOption(key,
	...
	public static SpruceSimpleActionOption textured(String key, SpruceButtonWidget.PressAction action,
	                                                int u, int v, int hoveredVOffset, ResourceLocation texture, int textureWidth, int textureHeight, @Nullable Component tooltip) {
		return new SpruceSimpleActionOption(key,
	...
	public interface ButtonFactory {
		SpruceButtonWidget build(Position position, int width, Component message, SpruceButtonWidget.PressAction action);
	}
}
